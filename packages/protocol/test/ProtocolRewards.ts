...
describe('Protocol Rewards', () => {
    ...
    describe.only('Verify Deployment', () => {
        ...
        it('verify deployment', async () => {
            ...
            console.log("moxieTokenAddress", moxieTokenAddress);
            console.log("tokem", await protocolRewards.token());
...
describe.only('Protocol Rewards WETH', () => {
    ...
    describe.only('Verify WETH Deployment', () => {
    ...
    describe.only("withdrawWETH", () => {
        ...
        it.only("should successfully withdraw rewards", async () => {
            const {
                owner,
                deployer,
                wethToken,
            ...
            console.log("wethToken BAL", await wethToken.balanceOf(owner.address));
            ...
            // Verify balances updated correctly
            expect(await protocolRewards.balanceOf(deployer.address)).to.equal(initialRewardsBalance - withdrawAmount);
            expect(await ethers.provider.getBalance(deployer.address)).to.equal(initialETHBalance + withdrawAmount);
        });
