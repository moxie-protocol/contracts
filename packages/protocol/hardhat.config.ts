...
const config: HardhatUserConfig = {
  ...
  networks: {
    baseSepolia: {
      ...
      accounts: {
        mnemonic: "spoon valley thumb cotton claw radio mutual neutral gallery space movie seminar below room kitten"
      },
      gasPrice: 1000000000,
  ...
  , etherscan: {
    apiKey: {
      "baseSepolia": 'VI7WA7F9FCRKC3T1NC77VMMPXNCFZ5J5GC'!,
     },
    customChains: [
      {
        network: "baseSepolia",
