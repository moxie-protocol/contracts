...
const vestingDepositAndLock = async () => {
 ...
 const amount = "3507329287825713141"
 ...
 // console.log(await tokenLockWallet.connect(owner).approveSubjectToken(subject))
 const calldata = getDepositAndLockCalldata(subject, amount, lockPeriod.toString())
